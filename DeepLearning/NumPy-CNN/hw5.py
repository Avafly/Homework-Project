...
# import nn_layers module made by me
...
# print out the size of the training and test data for checking
...
########################
# Set learning rate, batch size and total number of epochs for training
########################
lr = 1.5e-2
n_epoch = 2
batch_size = 100
