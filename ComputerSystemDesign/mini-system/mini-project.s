...
waitSGI:
    ...
    // set openTask=1 after the SGI configuration.
    ldr r0, =openTask
    ldr r1, [r0]
    cmp r1, #0
...
branchToTask1:
    ldr r0, =openTask
    mov r1, lr
    str r1, [r0, #4]        // 将open下一个task的pc (Program Counter)保存到openTask[1]
...
// count task, count=3 means 3 tasks have been opened
